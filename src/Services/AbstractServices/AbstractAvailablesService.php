...
class AbstractAvailablesService
{
    public static function get(AvailablesQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new AvailablesQueryFilter(new Request());
        }
        ...
        $model = Availables::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?Availables
    {
        return Availables::findByRef($ref);
    }
     ...
     */
    public static function getById($id) : ?Availables
    {
        return Availables::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = Availables::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        try {
            $model = Availables::create($data);
        } catch(\Exception $e) {
            throw $e;
        }

        Events::fire('created:NextDeveloper\Events\Availables', $model);
     ...
     * @return Availables
     */
    public static function updateRaw(array $data) : ?Availables
    {
    ...
    public static function update($id, array $data)
    {
        ...
        Events::fire('updated:NextDeveloper\Events\Availables', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\Events\Availables', $model);
